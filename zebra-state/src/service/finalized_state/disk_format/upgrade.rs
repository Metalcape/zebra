...
fn format_upgrades(
    ...
    ([
        ...
        // History node upgrade
        Box::new(add_history_nodes::AddHistoryNodes::new(26, 1, 0)),
...
impl DbFormatChange {
    ...
    pub(crate) fn run_format_change_or_check(
        ...
        Self::format_validity_checks_detailed(db, initial_tip_height, cancel_receiver)?.unwrap_or_else(|_| {
            panic!(
